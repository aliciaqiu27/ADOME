...
//zipcode application
    var clientKey = "itnYR1Hs3bxzQsyVL8EBAnWiLysM3VCcZMBWeQWM94piUcctz88ZI93097hEwZ4v";
		...
		container.find("input[name='zipcode']").on("keyup change", function() {
			...
			if (zipcode.length == 5 && /^[0-9]+$/.test(zipcode))
			{
				...
				{
					// Build url
					var url = "https://www.zipcodeapi.com/rest/"+itnYR1Hs3bxzQsyVL8EBAnWiLysM3VCcZMBWeQWM94piUcctz88ZI93097hEwZ4v+"/info.jjs-9qZHzu2Flc59Eq5rx10JdKERovBlJp3TQ3ApyC4TOa3tA8U7aVRnFwf41RpLgtE7son/" + zipcode + "/radians";
